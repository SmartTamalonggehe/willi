...
@section('css')
    ...
    <link href="{{ asset('toolsAdmin/plugins/custom/fullcalendar/fullcalendar.bundle.css?v=7.0.5') }}" rel="stylesheet"
        type="text/css" />
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="col bg-light-primary px-6 py-8 rounded-xl mb-7">
                ...
                <span
                    class="ml-2 text-primary font-weight-bold font-size-h6">@currency($kasBulanIni->sum('pemasukan'))</span>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="col bg-light-primary px-6 py-8 rounded-xl mb-7">
                ...
                <span
                    class="ml-2 text-primary font-weight-bold font-size-h6">@currency($kasTahunIni->sum('pemasukan'))</span>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="col bg-light-danger px-6 py-8 rounded-xl mb-7">
                ...
                <span
                    class="ml-2 text-danger font-weight-bold font-size-h6">@currency($kasBulanIni->sum('pengeluaran'))</span>
            </div>
        </div>
        <div class="col-sm-6">
            <div class="col bg-light-danger px-6 py-8 rounded-xl mb-7">
                ...
                <span
                    class="ml-2 text-danger font-weight-bold font-size-h6">@currency($kasTahunIni->sum('pengeluaran'))</span>
            </div>
        </div>
    </div>
...
@section('js')
    ...
    {{-- <script
        src="{{ asset('toolsAdmin/js/pages/features/charts/apexcharts.js?v=7.0.5') }}"></script>
    --}}
