...
@section('judul','Jenis Pemasukan')

@section('jenisPemasukan','menu-item-active')
...
@include('admin.jenis_pemasukan.form')
	...
	<script>  
		...
		$(document).ready(function () {
			$("#formKu").on('submit',function(e){
			  ...
			  if (save_method=="add") { 
				  url="{{ route('jenisPemasukan.store') }}"
				  method="POST"
			  } else {
				  url="jenisPemasukan/"+id
				  method="PUT"
			  }
			  $.ajax({
			  url: url,
