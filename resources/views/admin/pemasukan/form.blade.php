                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group input-group date">
                            <label for="kt_datepicker_4_4">Tgl. Pemasukan</label>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <label for="rupiah1">Jumlah Pemasukan</label>
                            <input type="text" id="rupiah1" name="pemasukan" class="form-control">
                        </div>
                    </div>
